...
class FiltersBtn extends Component {
    constructor() {
        super();
        this.state = {
            gameLength: [],
    ...
    render() {
        ...
        return (
            <div className='filters '>
                <Row className="justify-content-md-center fadeInDown">
                    <Col md="11" className="d-md-block d-none allFilters">
                        <Row>
                ...
                <Cards games={this.state.allGames} />
            </div>
        );
    }
}
